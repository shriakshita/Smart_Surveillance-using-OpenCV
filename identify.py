...
def collect_data():
	...
	while True:
		...
		for x,y,w,h in faces:
			...
			cv2.imwrite(f"persons/{name}-{count}-{ids}", roi)
			count = count + 1
...
def train():
	...
	#dataset = "C:\\Users\\AKSHAY AKSHITA\\OneDrive\\Desktop\\mini project pratice(tkinter)\\archive (1)"
	dataset="C:\\Users\\AKSHAY AKSHITA\\OneDrive\\Desktop\\mini project pratice(tkinter)\\persons"
...
def identify():
	...
	filename = "haarcascade_frontalface_default.xml"
	#filename = "C:\\Users\\AKSHAY AKSHITA\\OneDrive\\Desktop\\mini project pratice(tkinter)\\haarcascade_frontalface_default.xml"
	...
	while True:
		...
		for x,y,w,h in faces:
			...
			if label[1] < 100:
				...
				cv2.putText(frm, "Akshita", (x,y), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 3)
